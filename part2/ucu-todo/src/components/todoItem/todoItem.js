...
export default class TodoItem extends Stepan.Component {
    render({isDone, title}) { // render will always accept data to render
        ...
        //   if (element.getElementsByTagName("label")[0] !== 'undefined' && element.getElementsByTagName("label")[0].innerText === title) {
        //
        //   }
        // }
        ...
        if (isDone) {
            ...
            Stepan.createElement('input', todoViewContainer, {class: "toggle", type: "checkbox", checked: "false"});
        }
